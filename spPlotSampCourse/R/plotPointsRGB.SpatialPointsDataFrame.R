#-------------------------------------------------------------------------------
#
#           plotPointsRGB.SpatialPointsDataFrame
#
#-------------------------------------------------------------------------------

#' Plots SpatialPointsDataFrame Points and Colors Them 
#'
#' Plots ppatialPointsDataFrame points and colors them according to values in a specified column of the data.frame in a SpatialPointsDataFrame
#'
...
#' @param hminmax user-specified limits for the values of colorCol.  Default is NULL, in which case the limits of the observed values are used.  If specified, it should be a vector of two values.  If any values of the observed data exceed the limits, and error is returned.
#'
...
#' @method plotPointsRGB SpatialPointsDataFrame
#' @S3method plotPointsRGB SpatialPointsDataFrame

plotPointsRGB.SpatialPointsDataFrame <- function(x, colorCol,
