...
\frametitle{Simulation}
	...
	<<sim2-plot, fig.width=6, fig.height=6, echo=FALSE, include = FALSE>>=
	library(spPlotSampCourse)
#-------------------------------------------------------------------------------
#  SAMPLE PLOTS
#-------------------------------------------------------------------------------
...
ab <- coef(lm(o ~ e, data = data.frame(o = fits, 
	e = (counts - fits)^2/fits)))
...
ab <- coef(lm(o ~ e - 1, data = data.frame(o = fits, 
	e = (counts - fits)^2/fits)))
